...
\definecolor{blue1}{HTML}{7AA2F7}
\definecolor{blue2}{HTML}{2AC3DE}
\definecolor{green1}{HTML}{9ECE6A}
\definecolor{orange1}{HTML}{FF9E64}
\definecolor{purple1}{HTML}{BB9AF7}
\definecolor{red1}{HTML}{F7768E}
\definecolor{yellow1}{HTML}{E0AF68}
\definecolor{teal1}{HTML}{73DACA}
\definecolor{cyan1}{HTML}{7DCFFF}
\definecolor{gray1}{HTML}{565F89}
\definecolor{gray2}{HTML}{414868}

% ─── Listings ─────────────────────────────────────────────────────
\lstdefinestyle{code}{
    backgroundcolor=\color{bg},
    basicstyle=\ttfamily\fontsize{7}{8.5}\selectfont\color{fg},
...
\begin{enumerate}[leftmargin=*,topsep=2pt,itemsep=1pt]
    ...
    \item \textbf{Mandatory Access Control} (SELinux~\cite{smalley2001implementing},
          ...
          channels the agent is permitted to use~\cite{jain2023baseline}.
...
ben2010taming}. Unlike container runtimes that share the host kernel
...
agent tool-use safety. Jain et al.~\cite{jain2023baseline} establish
...
smaller than the Linux kernel ($\sim$30\,MLOC).
...
declarations; and formal verification of the vchan tunnel
implementation using verified software toolchains.
...
access, hypervisor-level isolation represents a necessary evolution
from a security best practice to a deployment requirement.
...
Anthropic,
``The Claude model card and system prompt,''
...
N.~Jain, K.~Saeta, D.~Agarwal, et al.,
``Baseline defenses for adversarial attacks against aligned language models,''
\textit{arXiv:2309.00614}, 2023.
...
\bibitem{gao2024taxonomy}
Y.~Gao, T.~Xiong, X.~Gong, et al.,
``A taxonomy of LLM agent tool use,''
\textit{arXiv:2406.09345}, 2024.
...
\bibitem{ben2010taming}
M.~Ben-Yehuda, M.~D.~Day, Z.~Dubitzky, et al.,
``The taming of the hypervisor: The past, present, and future of
virtualization,''
\textit{ACM Queue}, vol.~8, no.~1, 2010.
